...
// 获取当天的结束时间
    ...
    //获取昨天天的开始时间
    public static   Long getLastHourStartTime() {
        Calendar todayStart = Calendar.getInstance();
        todayStart.set(Calendar.SECOND, 0);
        todayStart.set(Calendar.MINUTE, 0);
//        todayStart.set(Calendar.HOUR_OF_DAY, 0);
    ...
    //获取昨天的结束时间
    public static  Long getLastHourEndTime() {
        Calendar todayEnd = Calendar.getInstance();
        todayEnd.set(Calendar.SECOND, 59);
        todayEnd.set(Calendar.MINUTE, 59);
//        todayEnd.set(Calendar.HOUR_OF_DAY, 23);
        todayEnd.set(Calendar.MILLISECOND, 999);
        todayEnd.add(Calendar.HOUR_OF_DAY, -1);
        return todayEnd.getTimeInMillis();
    }
...
// 获取昨天的结束时间
    ...
    public static Date getBeginDayOfSevenYesterday() {
...
//        String greenDate = sdf.format(cd.getTime());
        Calendar cd = Calendar.getInstance();
        String greenDate = String.valueOf(cd.getTimeInMillis());
        return greenDate;
    }
